...
data_dir = st.sidebar.text_input("Pfad zu Bilddaten (ImageFolder)", "./data/pets_subset_mini")
...
if not os.path.exists(data_dir):
    st.warning("❗ Bitte gib einen gültigen Datenpfad an – z. B. './data/pets_subset_mini'")
    st.stop()
